    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Ticket",
          type: "error",
          message: error.message || "Failed get ticket",
        });
      });
    ...
    <div className="col-12 flex flex-column align-items-center">
      ...
      <div className="grid col-10">
        <div className="card w-full">
          ...
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.DateRaised}</p>
          </div>
          ...
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.assignedTo}</p>
          </div>
          <label className="text-sm text-primary">DateAssigned</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.DateAssigned}</p>
          </div>
          <label className="text-sm text-primary">DateClosed</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.DateClosed}</p>
          </div>
