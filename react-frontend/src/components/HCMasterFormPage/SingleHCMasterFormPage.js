    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">RefNo</label>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.DateInspec}</p></div>
                    <label className="text-sm text-primary">DateRecall</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.DateRecall}</p></div>
                    ...
                    <div className="ml-3"><i className={`pi ${_entity?.ActiveCase?"pi-check": "pi-times"}`}  ></i></div>
