...
const HCMasterFormDataTable = ({
  ...
  const inputTemplate1 = (rowData, { rowIndex }) => (
    <InputText value={rowData.Model} />
  );
  const inputTemplate2 = (rowData, { rowIndex }) => (
    <InputText value={rowData.SerialNo} />
  );
  const inputTemplate3 = (rowData, { rowIndex }) => (
    <InputText value={rowData.ManuYear} />
  );
  const inputTemplate4 = (rowData, { rowIndex }) => (
    <InputText value={rowData.Branch} />
  );
  ...
  const inputTemplate7 = (rowData, { rowIndex }) => (
    <InputText value={rowData.RecallLoc} />
  );
