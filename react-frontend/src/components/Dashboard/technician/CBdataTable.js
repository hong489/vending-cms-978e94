...
const CBMasterFormDataTable = ({
  ...
  const editMaster = (rowData, { rowIndex }) => (
    <Button
      onClick={() => editCBmaster(rowData, rowIndex)}
  ...
  const editStage1 = (rowData, { rowIndex }) => (
    <Button
      onClick={() => editCBStage1(rowData, rowIndex)}
      icon={`pi ${rowData.isEdit ? "pi-check" : "pi-pencil"}`}
      className={`p-button-rounded p-button-text ${rowData.isEdit ? "p-button-success" : "p-button-warning"}`}
    />
  );
  ...
  const editStage1Agree = (rowData, { rowIndex }) => (
    <Button
      onClick={() => editCBAgree1(rowData, rowIndex)}
      icon={`pi ${rowData.isEdit ? "pi-check" : "pi-pencil"}`}
      className={`p-button-rounded p-button-text ${rowData.isEdit ? "p-button-success" : "p-button-warning"}`}
    />
  );
  ...
  const editStage2 = (rowData, { rowIndex }) => (
    <Button
      onClick={() => editCBStage2(rowData, rowIndex)}
      icon={`pi ${rowData.isEdit ? "pi-check" : "pi-pencil"}`}
      className={`p-button-rounded p-button-text ${rowData.isEdit ? "p-button-success" : "p-button-warning"}`}
    />
  );
  ...
  const editStage2Agree = (rowData, { rowIndex }) => (
    <Button
      onClick={() => editCBAgree2(rowData, rowIndex)}
      icon={`pi ${rowData.isEdit ? "pi-check" : "pi-pencil"}`}
      className={`p-button-rounded p-button-text ${rowData.isEdit ? "p-button-success" : "p-button-warning"}`}
    />
  );
