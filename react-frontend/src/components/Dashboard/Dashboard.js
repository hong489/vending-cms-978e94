            ...
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/hcStage1">
                <div
                  ...
                  style={{ height: "10rem" }}
                >
                  <div className="text-900 font-medium text-lg">HcStage1</div>
                </div>
              </Link>
            </div>
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/hcStage2">
                <div
                  ...
                  style={{ height: "10rem" }}
                >
                  <div className="text-900 font-medium text-lg">HcStage2</div>
                </div>
              </Link>
            </div>
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/hcStage1Agree">
                <div
                  className="card mb-0 flex flex-column align-items-center justify-content-center hover zoom"
                  style={{ height: "10rem" }}
                >
            ...
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/cbStage1">
                <div
                  ...
                  style={{ height: "10rem" }}
                >
                  <div className="text-900 font-medium text-lg">CbStage1</div>
                </div>
              </Link>
            </div>
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/cbStage2">
                <div
                  ...
                  style={{ height: "10rem" }}
                >
                  <div className="text-900 font-medium text-lg">CbStage2</div>
                </div>
              </Link>
            </div>
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/cbStage1Agree">
                <div
                  className="card mb-0 flex flex-column align-items-center justify-content-center hover zoom"
                  style={{ height: "10rem" }}
                >
            ...
            <div className="col-12 lg:col-6 xl:col-4">
              <Link to="/ticket">
                <div
                  ...
                  style={{ height: "10rem" }}
                >
                  <div className="text-900 font-medium text-lg">Ticket</div>
                </div>
              </Link>
            </div>
