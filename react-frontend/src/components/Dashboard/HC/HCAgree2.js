...
const HCAgree2 = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      const eagerResult = await client.service("hcStage2Agree").find({
        query: {
          $limit: 100,
          _id: { $in: [result._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info hcStage2Agree updated successfully",
      });
  ...
  return (
    <div className="card grid agreement " style={{ background: "#fff59d" }}>
      ...
      <div className="grid col-12 flex-row">
        ...
        <div className="col-2">
          <Checkbox
            onChange={(e) => setValByKey("TechTrade", e.checked ? true : null)}
        ...
        <div className="col-1">
          <Checkbox
            onChange={(e) => setValByKey("TechTrade", e.checked ? false : null)}
      ...
      <div className="grid col-12 flex-row">
        ...
        <div className="col-2">
          <Checkbox
            onChange={(e) => setValByKey("MngrTrade", e.checked ? true : null)}
        ...
        <div className="col-1">
          <Checkbox
            onChange={(e) => setValByKey("MngrTrade", e.checked ? false : null)}
...
export default connect(mapState, mapDispatch)(HCAgree2);
