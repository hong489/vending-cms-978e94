    ...
    >
      <div role="hcStage2Agree-create-dialog-component">
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.TechTrade}
            onChange={(e) => setValByKey("TechTrade", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.SvTrade}
            onChange={(e) => setValByKey("SvTrade", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.MngrTrade}
            onChange={(e) => setValByKey("MngrTrade", e.target.value)}
          />
        </div>
        <div>
