    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "CbStage2Agree",
          type: "error",
          message: error.message || "Failed get cbStage2Agree",
        });
      });
    ...
    <div className="col-12 flex flex-column align-items-center">
      ...
      <div className="grid col-10">
        <div className="card w-full">
          ...
          <div className="ml-3">
            <img src={_entity?.TechSign} width={300} />
          </div>
          <label className="text-sm text-primary">TechDate</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.TechDate}</p>
          </div>
          <label className="text-sm text-primary">TechTrade</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.TechTrade}</p>
          </div>
          ...
          <div className="ml-3">
            <img src={_entity?.SvSign} width={300} />
          </div>
          <label className="text-sm text-primary">SvDate</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.SvDate}</p>
          </div>
          <label className="text-sm text-primary">SvTrade</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.SvTrade}</p>
          </div>
          ...
          <div className="ml-3">
            <img src={_entity?.MngrSign} width={300} />
          </div>
          <label className="text-sm text-primary">MngrDate</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.MngrDate}</p>
          </div>
          <label className="text-sm text-primary">MngrTrade</label>
          <div className="ml-3">
            <p className="m-0 ml-3">{_entity?.MngrTrade}</p>
          </div>
