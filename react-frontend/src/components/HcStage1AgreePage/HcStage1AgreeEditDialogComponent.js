    ...
    >
      <div role="hcStage1Agree-edit-dialog-component">
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.TechProceed}
            onChange={(e) => setValByKey("TechProceed", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.SvProceed}
            onChange={(e) => setValByKey("SvProceed", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.ManagerSign}
            onChange={(e) => setValByKey("ManagerSign", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.ManagerProceed}
            onChange={(e) => setValByKey("ManagerProceed", e.target.value)}
          />
        </div>
        <div>
...
export default connect(
  mapState,
  mapDispatch,
)(HcStage1AgreeCreateDialogComponent);
