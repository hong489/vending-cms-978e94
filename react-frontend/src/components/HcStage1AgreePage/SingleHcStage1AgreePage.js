    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Ref</label>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.TechDate}</p></div>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.SvDate}</p></div>
                    ...
                    <div className="ml-3"><img src={_entity?.ManagerSign} width={300}  /></div>
                    <label className="text-sm text-primary">ManagerDate</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.ManagerDate}</p></div>
